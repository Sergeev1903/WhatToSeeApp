...
final class MovieFavoritesManager {
    ...
    func addToFavorites(movieID: Int) {
        var favoriteIDs = UserDefaults.standard.array(
          forKey: "favoriteMovieIDs") as? [Int] ?? []
    ...
    func isFavorite(movieID: Int) -> Bool {
        let favoriteIDs = UserDefaults.standard.array(
          forKey: "favoriteMovieIDs") as? [Int] ?? []
